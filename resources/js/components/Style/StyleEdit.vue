                                   ...
                                   <table class="table">
                                     ...
                                     <tbody>
                                        <tr v-for="singledata in styleitems" :key="singledata.id">
                                           ...
                                           <td>
                                              <div class="btn-group">
                                                  <a href="javascript:void(0)" @click="deleteData(singledata.id)" class="btn   btn-primary">Remove</a>
                                              </div>
                                           </td>
                                       </tr>
        ...
        methods:{
           deleteData(id)
           {
            ...
            submitdata(e)
            {
                ...
                axios.post('/api/style-store-more', formData, config)
                .then((res) => {
                    this.processing = false;
                    this.messages = res.data.msg;
                          if(res.data.status == 0)
                          {
                            this.sdata.buyers_email = "";
                            this.$swal.fire({
                               icon: 'error',
